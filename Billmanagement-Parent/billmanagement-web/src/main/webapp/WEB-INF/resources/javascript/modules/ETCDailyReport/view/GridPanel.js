Ext.define('ETCDailyReportModule.view.GridPanel', {
    ...
    initComponent: function() {
    	// Create Store Object
    	var store = Ext.create('ETCDailyReportModule.store.ETCDailyReport');
                    ...
                    action: 'del',
	 	   		    listeners: {
		   			   click: function() {
		   				    ...
		   				    applet.ppr("etcDailyReport", {date: store.getProxy().extraParams["beginDate"]});
		   			   }
		   		    }
                }]
            })
